...
export default function ProjectModal({
  ...
  return createPortal(
    ...
    >
      <div className="absolute inset-0 bg-ink/35 backdrop-blur-md" onClick={close} aria-hidden="true" />

      <div
        data-lenis-prevent
        className={`relative z-10 w-full max-w-2xl max-h-[88vh] overflow-y-auto rounded-2xl border border-line bg-surface shadow-[0_28px_90px_rgba(23,22,29,0.22)] transition-all duration-300 ${
      ...
      >
        <button
          onClick={close}
          aria-label={t('close')}
          className="absolute top-4 right-4 z-20 flex h-9 w-9 items-center justify-center rounded-full border border-line bg-surface/80 text-ink-3 backdrop-blur-sm hover:text-ink hover:border-iris/45 transition-colors duration-200"
        >
          ✕
        </button>
        ...
        <img
          ...
          alt=""
          className="aspect-[16/9] w-full rounded-t-2xl border-b border-line object-cover"
        />
        ...
        <div className="p-6 sm:p-8">
          ...
          <p className="mb-6 leading-relaxed text-ink-2">{t(`items.${id}.long`)}</p>
          ...
          <div className="flex flex-wrap gap-3">
            {website && (
              <a
                ...
                className="group inline-flex items-center gap-2 rounded-full bg-ink px-5 py-2.5 text-sm font-medium text-paper transition-colors duration-300 hover:bg-iris"
              >
                {t('visitSite')} {ARROW}
              </a>
            )}
            {github && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 rounded-full border border-iris/35 px-5 py-2.5 text-sm font-medium text-iris transition-colors duration-300 hover:bg-iris/5"
              >
